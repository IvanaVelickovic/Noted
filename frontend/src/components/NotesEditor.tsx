...
function NotesEditor({
  ...
  const { updateNote, deleteNote } = useNoteActions(fetchNotes);
  ...
  return (
    <div className="w-[76%]">
      ...
      {showDetails && (
        <div className="shrink-0 p-3 border-b-2 border-b-input-border flex items-center justify-between bg-[#F3ECE5] px-4.5">
          <div className="flex gap-x-9">
            ...
            <div>
              <h3 className="font-mono text-date-notes text-sm">LAST EDITED</h3>
              <p className="font-mono text-paragraph text-sm">
      ...
      <div className="flex-1 min-h-0 flex flex-col p-8 pt-12 overflow-y-auto">
        ...
        ></textarea>
        <textarea
          className="text-[#5A3F45] text-[1.05rem] w-full h-112 outline-none resize-none"
          value={body}
