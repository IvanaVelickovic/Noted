    ...
    <div className="w-[24%] flex flex-col border-r-2 border-r-input-border">
      ...
      <div className="flex justify-between items-center p-3 border-b-2 border-b-input-border">
        ...
        <div className="flex gap-x-2 h-7">
          <img src="./images/logout_button.png"></img>
          <img src="./images/add_button.png"></img>
        </div>
      </div>

      <div className="flex flex-col justify-between h-full">
        {/* NOTES */}
        <ul className="flex flex-col my-1 overflow-y-auto overflow-x-hidden max-h-115 cursor-pointer">
          <li className="flex flex-col p-3 gap-y-0.5">
            <h3 className="text-header text-lg">Cell divison and Mitosis</h3>
          ...
          <li className="flex flex-col p-3 gap-y-0.5 bg-note-fill border-l-[3px] border-l-button-bg">
            <h3 className="text-header text-lg">Cell divison and Mitosis</h3>
            <div className="flex gap-x-5">
              <div className="font-mono text-sm text-[#7ECFAB] bg-[#7ECFAB]/15 rounded-lg px-0.5 py-px">
                Biology
        ...
        {/* CATEGORIES */}
        <div className="border-t-2 border-t-input-border flex flex-col gap-y-0.5 p-3 max-h-45">
